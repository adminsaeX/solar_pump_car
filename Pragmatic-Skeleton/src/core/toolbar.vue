<template>
	<div class="toolbar flex align-center justify-space-between">
		...
		<div class="box-right flex align-center pl-10">
			...
			<span class="username"><router-link to="/profile">{{User}}</router-link></span>
			<el-dropdown trigger="click" @command="onCommand">
				<span class="el-dropdown-link">
					<img src="../assets/images/avatar-2.jpg" class="avatar" alt="avatar">
				</span>
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item command="/profile"><i class="mdi mdi-account mr-10"></i>ข้อมูลส่วนตัว</el-dropdown-item>
					<el-dropdown-item @click.native="logOut()" command="/logout" divided><i class="mdi mdi-logout mr-10"></i>ลงชื่อออก</el-dropdown-item>
				</el-dropdown-menu>
			</el-dropdown>
